      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin/jugos') }}">Jugos</a></li>
              ...
              <div class="content-box-large">
                ...
                <div class="panel-body">
                    ...
                    <section class="example mt-4">
                      ...
                      <form method="POST" action="{{ route('admin/jugos/update',$jugos->id) }}" role="form" enctype="multipart/form-data">
